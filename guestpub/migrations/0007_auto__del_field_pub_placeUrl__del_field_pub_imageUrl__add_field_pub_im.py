...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Pub.placeUrl'
        db.delete_column(u'guestpub_pub', 'placeUrl')

        # Deleting field 'Pub.imageUrl'
        db.delete_column(u'guestpub_pub', 'imageUrl')

        # Adding field 'Pub.imageurl'
        db.add_column(u'guestpub_pub', 'imageurl',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Pub.placeurl'
        db.add_column(u'guestpub_pub', 'placeurl',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=256, blank=True),
                      keep_default=False)
