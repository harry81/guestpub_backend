...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pub.placeUrl'
        db.alter_column(u'guestpub_pub', 'placeUrl', self.gf('django.db.models.fields.URLField')(max_length=256))

        # Changing field 'Pub.imageUrl'
        db.alter_column(u'guestpub_pub', 'imageUrl', self.gf('django.db.models.fields.URLField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'Pub.placeUrl'
        db.alter_column(u'guestpub_pub', 'placeUrl', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Pub.imageUrl'
        db.alter_column(u'guestpub_pub', 'imageUrl', self.gf('django.db.models.fields.CharField')(max_length=256))
