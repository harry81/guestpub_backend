...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Pub'
        db.create_table(u'guestpub_pub', (
            ('refer_id', self.gf('django.db.models.fields.CharField')(default='', max_length=20, primary_key=True)),
            ...
            ('address', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True)),
            ('imageUrl', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True)),
            ('category', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True)),
            ('placeUrl', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True)),
            ('point', self.gf('django.contrib.gis.db.models.fields.PointField')(default='POINT(0 0)', blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'guestpub', ['Pub'])

        # Adding model 'PubListPlugin'
        db.create_table(u'guestpub_publistplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('number', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'guestpub', ['PubListPlugin'])


    def backwards(self, orm):
        # Deleting model 'Pub'
        db.delete_table(u'guestpub_pub')

        # Deleting model 'PubListPlugin'
        db.delete_table(u'guestpub_publistplugin')
